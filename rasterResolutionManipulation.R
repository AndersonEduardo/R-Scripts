...
library(raster)
###
hii = raster(x='/home/anderson/PosDoc/dados_ambientais/hii-s-america-geo-grid/hii_s_america_grid/hii_s_amer')
...
writeRaster(hiiSA2,'/home/anderson/PosDoc/dados_ambientais/hii-s-america-geo-grid/res2-5/hii-2-5.asc')
